 ...
 * number. Cluster A (MERR/South) -> +62 811-0000-0001, Cluster B
 * (Manyar/Central) -> +62 811-0000-0002. Wrong routing is a real business bug.
 *
...
/**
 * Convert a display-form phone number (e.g. "+62 811-0000-0001" or
 * "0811-0000-0001") to digits-only with an Indonesian country code prefix.
 */
