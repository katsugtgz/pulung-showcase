...
export default async function SiswaDashboardPage() {
  ...
  return (
    <div className="flex flex-col gap-8">
      {/*
        Bilah UserMenu khusus mobile. Pada desktop (lg+) header AppShell sudah
        menyediakan menu profil — di-hide di sini untuk menghindari duplikat
        (spec #59: "Clerk UserButton di header melayani profil"). Mobile tidak
        punya header, jadi menu profil perlu tetap tersedia untuk sign-out.
      */}
