...
- **Never hardcode business data in UI** — branch numbers, WA numbers, prices flow only through `src/lib/catalog-data/`. Wrong WA cluster routing (A vs B) is a **real business bug**, not a code smell. Cluster A (MERR/South) `+62 851-0087-0957`, Cluster B (Manyar/Central) `+62 812-3253-1989`.
