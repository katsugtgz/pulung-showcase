...
| **Total biaya tahun kedua dan seterusnya** | **Rp400.000/bulan** |
...
2. Admin dapat:
   - mengelola jadwal instruktur;
   - mengelola data siswa; dan
   - mengelola jadwal siswa.
3. Admin melakukan logout.

### Siswa

1. Siswa melakukan registrasi.
2. Siswa melakukan login.
3. Siswa memilih paket.
4. Siswa membayar melalui QRIS.
5. Jika pembayaran belum berhasil, siswa mengulangi pembayaran.
6. Jika pembayaran berhasil, siswa memilih jadwal.
7. Sistem menerbitkan invoice dan kartu siswa.
8. Siswa melakukan logout.
...
- **Alamat:** RW Warehouse, Jl. Medokan Asri Barat VIII M-20
- **WhatsApp:** [0821-4265-0098](https://wa.me/6282142650098)
